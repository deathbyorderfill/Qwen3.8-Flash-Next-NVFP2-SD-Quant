...
def _fp2_configs(num_rows: int, K_up: int, K_down: int):
    """SDnvfp2 tile heuristic for fused_moe_kernel_fp2 (measured on GB10).
...
def _prepare_fused_moe_run(
    ...
    *,
    ...
    if use_fp2_w2a16:
        # SDnvfp2: no GB10 config files exist; use the measured tile heuristic
...
def _fused_moe_kernel_sequence(
    ...
    *,
    ...
    use_fused_moe_sum_all_reduce = (
        ...
        and (not use_fp2_w2a16)  # SDnvfp2: fp2 kernel has no all-reduce combine epilogue
    )
