...
def _resolve_explicit_draft_quant_config(
    ...
    if _os.environ.get("SGLANG_DRAFT_UNQUANT") == "1":
        # BF16 draft head: skip the online-FP4 swap below; the mtp weights are
        # BF16-serialized, so the whole draft loads unquantized.
        return None
